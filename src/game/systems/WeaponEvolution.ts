...
export const RANDOM_EVOLUTION_BRANCHES: WeaponEvolutionBranch[] = [
  ...
  { id: 'yukata-festival-fans', title: 'YUKATA FESTIVAL', subtitle: '浴衣祭扇。横風の花火斬撃', module: 'bladebit', archetype: 'sakura', element: 'fire', imageKey: 'weaponYukataFestivalFans', specialStyle: 'blade', power: 7, fireRate: 0.18, critRate: 0.055, pierce: 1, shield: 1, synergy: 5 },
];
...
const EVOLUTION_POOLS_BY_STARTER: Record<string, string[]> = {
  ...
  'slash-speed': ['ichigo-speed-saber', 'grape-speed-saber', 'yukata-festival-fans', 'scarlet-speed-saber', 'jade-storm-fan', 'moon-guillotine', 'crimson-meteor-katana', 'azure-tempest-chakram', 'chrono-needle-spear', 'magma-drill-trident'],
...
export const STARTER_WEAPONS: StarterWeapon[] = [
  { id: 'shinkansen-rail-cannon', categoryId: 'cannon-barrage', title: 'SHINKANSEN RAIL', subtitle: '超高速鉄道砲。中央線を貫く', detail: '属性: 雷 / 得意: 直線配置、BOSS、敵弾相殺 / 戦い方: 中央線を維持すると未知の過速機構が目覚める。', attributeLabel: '雷・超特急', strongAgainst: '大型BOSS、縦列、低速弾幕', strategy: '中央付近で照準を安定させ、貫通レール弾を連続で通す。', weakness: '横に広がる敵と急な回避では加速を維持しにくい。', element: 'thunder', archetype: 'rail', imageKey: 'weaponShinkansenRailCannon', color: 0x22d3ee, stats: createStarterStats('thunder', 'rail', 9, 1.08, ['booster'], { rarity: 'rare', critRate: 0.09, pierce: 4, shield: 1, synergy: 5 }) },
  ...
  { id: 'aphrodite-rose-bow', categoryId: 'balance-bow', title: 'APHRODITE ROSE', subtitle: '愛神弓。美しく広がる誘導射撃', detail: '属性: 光 / 得意: 分散した雑魚、初見BOSS、回避しながらの戦闘 / 戦い方: 薔薇光の誘導弾で広く当て、会心と盾を少しずつ伸ばす。', attributeLabel: '光・薔薇弓', strongAgainst: '分散雑魚、動き回る敵、弾の薄いBOSS', strategy: '正面に固執せず、距離を取りながら安全に当て続ける。会心とシナジーが伸びると華やかに強くなる。', weakness: '重装BOSSへの瞬間突破は砲撃型に劣る。', element: 'light', archetype: 'seraph', imageKey: 'weaponAphroditeRoseBow', color: 0xf9a8d4, stats: createStarterStats('light', 'seraph', 6, 1.07, ['homing'], { critRate: 0.09, pierce: 1, shield: 1, synergy: 4 }) },
  { id: 'sunflower-solar-bow', categoryId: 'balance-bow', title: 'SUNFLOWER SOLAR', subtitle: '向日葵弓。太陽弾で広く削る', detail: '属性: 光 / 得意: 雑魚の群れ、分散敵、明るいステージ / 戦い方: 太陽弾を広くばらまき、会心と必殺ゲージを拾って盤面を押し上げる。', attributeLabel: '光・太陽弓', strongAgainst: '雑魚群、分散配置、低中耐久のBOSS', strategy: '中央を維持して幅広く当てる。RUSHアイテムとの相性がよく、育つほど安定する。', weakness: '真正面の重装相手は貫通型ほど早くない。', element: 'light', archetype: 'centaur', imageKey: 'weaponSunflowerSolarBow', color: 0xfacc15, stats: createStarterStats('light', 'centaur', 6, 1.08, ['homing'], { critRate: 0.085, pierce: 1, synergy: 5 }) },
  ...
  { id: 'flame-monkey-staff', categoryId: 'slash-speed', title: 'FLAME MONKEY', subtitle: '炎猿棍。跳ねる火炎斬撃', detail: '属性: 火 / 得意: 素早い雑魚、密集敵、短期決戦 / 戦い方: 炎の棍撃と斬撃で敵を刻み、会心で一気に押し切る。', attributeLabel: '火・猿棍', strongAgainst: '高速雑魚、密集敵、低中耐久BOSS', strategy: '止まらず回避しながら手数を当てる。会心と連射を伸ばすほど暴れるように強くなる。', weakness: '盾が薄く、長期弾幕戦では被弾管理が必要。', element: 'fire', archetype: 'samurai', imageKey: 'weaponFlameMonkeyStaff', color: 0xfb923c, stats: createStarterStats('fire', 'samurai', 8, 1.12, ['bladebit'], { critRate: 0.12, pierce: 1, synergy: 3 }) },
  { id: 'rooster-coil-glaive', categoryId: 'slash-speed', title: 'ROOSTER COIL', subtitle: '鶏鳴輪刃。煙渦で切り裂く', detail: '属性: 火 / 得意: 密集雑魚、横に広い群れ、状態異常敵 / 戦い方: 蚊取り線香のような渦斬撃で近い敵を巻き込み、会心で一気に削る。', attributeLabel: '火・渦斬撃', strongAgainst: '群れ、突進敵、細かく動く敵', strategy: '斬撃範囲と連射を伸ばす。敵の横移動に合わせて少しずつ軸をずらすと強い。', weakness: '遠距離BOSSへの正面相殺は砲撃型に劣る。', element: 'fire', archetype: 'vortex', imageKey: 'weaponRoosterCoilGlaive', color: 0xef4444, stats: createStarterStats('fire', 'vortex', 7, 1.13, ['bladebit'], { critRate: 0.105, pierce: 1, synergy: 4 }) },
  ...
  { id: 'yukata-festival-fans', categoryId: 'slash-speed', title: 'YUKATA FESTIVAL', subtitle: '浴衣祭扇。横風の花火斬撃', detail: '属性: 火 / 得意: 横から迫る群れ、素早い雑魚、BOSS取り巻き / 戦い方: 祭扇と髪飾り刃で横方向にも斬撃を飛ばし、会心と連射で華やかに押し切る。', attributeLabel: '火・祭扇', strongAgainst: '横並びの敵、密集雑魚、低中耐久BOSS', strategy: '連射、会心、シナジーを伸ばす。苺スロットの超大当たりと相性がよい。', weakness: '重装BOSSへの一撃火力は砲撃型に劣る。', element: 'fire', archetype: 'sakura', imageKey: 'weaponYukataFestivalFans', color: 0xff4770, stats: createStarterStats('fire', 'sakura', 7, 1.15, ['bladebit'], { critRate: 0.115, pierce: 1, shield: 1, synergy: 5 }) },
  ...
  { id: 'orbital-rocket-lance', categoryId: 'cannon-barrage', title: 'ORBITAL ROCKET', subtitle: '軌道ロケット槍。重推進で貫く', detail: '属性: 雷 / 得意: BOSS、直線配置、敵弾相殺 / 戦い方: ロケット推進の重弾で正面を押し返す。攻撃力と貫通を拾うとBOSS戦で頼れる。', attributeLabel: '雷・軌道砲', strongAgainst: '大型BOSS、装甲敵、丸弾/菱形弾', strategy: '正面を取り続ける。遅めの連射をRUSHアイテムで補うと一気に化ける。', weakness: '横に散る雑魚はやや取りこぼしやすい。', element: 'thunder', archetype: 'rail', imageKey: 'weaponOrbitalRocketLance', color: 0x38bdf8, stats: createStarterStats('thunder', 'rail', 10, 0.9, ['burst'], { critRate: 0.08, pierce: 3, synergy: 3 }) },
  ...
  { id: 'moist-calico-cat-cannon', categoryId: 'guard-aegis', title: 'MOIST CALICO', subtitle: '保湿三毛猫砲。しっとり結界', detail: '属性: 晶 / 得意: 長期戦、状態異常、事故が多いBOSS / 戦い方: 保湿バリアで粘り、回復と盾を重ねながらじっくり勝つ。', attributeLabel: '晶・保湿守護', strongAgainst: '長期戦、状態異常敵、弾幕BOSS、事故りやすい場面', strategy: '無理に火力勝負せず、盾と回復で生存を優先する。攻撃力アイテムを拾うと安定して削れる。', weakness: '序盤の殲滅速度は控えめ。', element: 'crystal', archetype: 'lotus', imageKey: 'weaponMoistCalicoCatCannon', color: 0xfbbf24, stats: createStarterStats('crystal', 'lotus', 5, 0.98, ['repair'], { critRate: 0.055, shield: 5, synergy: 6 }) },
